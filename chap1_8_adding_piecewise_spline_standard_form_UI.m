classdef chap1_8_adding_piecewise_spline_standard_form_UI < matlab.apps.AppBase
% Source is chap1_8_adding_piecewise_spline_standard_form_app.mlapp
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.XSlider.Limits = [10 90];
            app.XSlider.Position = [219 101 150 3];
            app.XSlider.Value = 10;
    ...
    methods (Access = public)
        ...
        % Construct app
        function app = chap1_8_adding_piecewise_spline_standard_form_UI
